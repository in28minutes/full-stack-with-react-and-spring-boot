...
```
diff --git a/frontend/todo-app/src/App.css b/frontend/todo-app/src/App.css
index b41d297..4faa8c2 100644
--- a/frontend/todo-app/src/App.css
+++ b/frontend/todo-app/src/App.css
@@ -1,33 +1 @@
-.App {
-  text-align: center;
-}
...
@@ -24,6 +30,63 @@ class TodoApp extends Component {
     }
 }
...
+            <header>
+                <nav className="navbar navbar-expand-md navbar-dark bg-dark">
+                    <div><a href="https://www.in28minutes.com" className="navbar-brand">
+                        in28minutes</a></div>
+
+                    <ul className="navbar-nav">
+                        <li><Link to="/welcome/in28minutes" className="nav-link">Home</Link></li>
...
+
 class ListTodosComponent extends Component {
     constructor(props){
         super(props)
@@ -39,32 +102,31 @@ class ListTodosComponent extends Component {
...
@@ -73,9 +135,15 @@ class ListTodosComponent extends Component {
...
@@ -141,13 +209,18 @@ class LoginComponent extends Component {
     render() {
         return (
             <div>
-                {/*<ShowInvalidCredentials hasLoginFailed={this.state.hasLoginFailed}/>*/}
...
+                <div class="container">
+                    {/*<ShowInvalidCredentials hasLoginFailed={this.state.hasLoginFailed}/>*/}
+                    {this.state.hasLoginFailed && <div class="alert alert-warning">Invalid Credentials</div>}
+                    {this.state.showSuccessMessage && <div>Login Sucessful</div>}
+                    {/*<ShowLoginSuccessMessage showSuccessMessage={this.state.showSuccessMessage}/>*/}
+
+                    User Name: <input type="text" name="username" value={this.state.username} onChange={this.handleChange}/>
+                    Password: <input type="password" name="password" value={this.state.password}  onChange={this.handleChange}/>
+                    <button onClick={this.loginClicked} class="btn btn-success">Login</button>
+                </div>
             </div>
         )
     }
...
@@ -24,6 +25,26 @@ class TodoApp extends Component {
     }
 }
