...
```
Fix the List Todo Headers
constants.js export const 
axios.defaults.baseURL = SERVER_API_URL;
DONE Step 86 - Importing JWT Framework into Eclipse.mp4  => Change Git Repos
DONE Step 87 - Quick Tip - Resolving JWT Compilation Errors.mp4 => Record Again
Step 93 - Connecting GET REST APIs to JPA Repository.mp4 => Record Again
Step 94 - Connecting POST, PUT and DELETE REST APIs to JPA Repository.mp4 => Record Again
Step 00 - Getting Started with the Course => Record 
Course Introduction Video  => Record 

React Templates Plugin
setState is asynchronous - an example!
 - interchange Target Date and is Completed? - Start of Camtasia file 8
...
Update HATEOAS for microservices course!
